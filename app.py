...
# Global storage (simple & sufficient for school use)
class_tt = {}
teacher_tt = {}
...
def home():
    ...
    for cid, info in CLASSES.items():
        ...
        ct_name = teachers.get(ct_id, {}).get("name", "Not Assigned")
...
def add_teacher_web():
    ...
    return render_template("add_teacher.html", subjects=SUBJECTS.keys())


# ---------------- GENERATE TIMETABLE ----------------
@app.route("/generate", methods=["GET", "POST"])
def generate_page():
    global class_tt, teacher_tt
